...
(function($)
{
	...
	$(document).ready( function()
	{
		...
		let initBookingPage = function ( value )
		{
          ...
          // console.log(params, async_param);
					var ajaxObject =
						{
				...
				{
					booknetic.ajax( 'confirm', booknetic.ajaxParameters( { step: 'confirm' } ), function ( result )
					{
					...
					loadStep: function( step )
					{
						...
						var loadNewStep = function()
						{
							...
							else
							{
								...
								booknetic.ajax( 'get_data_' + step_id, booknetic.ajaxParameters( { step } ), function ( result )
								{
				...
				addGroupAppointmentsCounterForBookneticCalendarDays: function () {
					...
					for ( const date in dates )
					{
						...
						booking_panel_js.find( `.booknetic_calendar_days[data-date=${date}] > div` ).append( `<div class="booknetic_time_group_num">${weight} / ${max_capacity}</div>` );
					}
				}
			};
